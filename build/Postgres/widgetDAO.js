...
class WidgetDao {
    constructor(pool) {
        this.save = (toSave) => __awaiter(this, void 0, void 0, function* () {
            try {
                let result = yield this._pool.query('INSERT INTO widget (id, name) VALUES ($1, $2);', [toSave.getId(), toSave.getName()]);
            }
            catch (error) {
                console.log(error);
            }
        ...
        this.update = (toUpdate) => __awaiter(this, void 0, void 0, function* () {
            try {
                let result = yield this._pool.query('UPDATE widget SET name = $1 WHERE id = $2', [toUpdate.getName(), toUpdate.getId()]);
            }
            catch (error) {
                console.log(error);
            }
        ...
        this.delete = (toDelete) => __awaiter(this, void 0, void 0, function* () {
            try {
                let result = yield this._pool.query('DELETE FROM widget WHERE id = $1;', [toDelete.getId()]);
            }
            catch (error) {
                console.log(error);
            }
